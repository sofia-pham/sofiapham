...
const Contact = () => {
  ...
  return (
    <section className="flex min-h-screen flex-col max-container">
      ...
      <div className="w-full flex flex-col justify-center items-center space-y-1 text-center lg:mt-12">
