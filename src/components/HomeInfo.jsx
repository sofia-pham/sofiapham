...
const InfoBox = ({ text, link, btnText }) => {
  return (
    <div className="relative sm:text-xl sm:leading-snug text-center bg-green-600 rounded-xl py-5 px-8 text-white mx-5 items-center flex flex-col">
      ...
      <Link
        to={link}
        className="absolute bottom-[-20px] bg-white text-green-600 font-semibold px-6 py-3 rounded-lg text-center hover:bg-green-800 hover:text-white shadow-md hover:shadow-lg"
      >
        {btnText}
      </Link>
    </div>
